...
class ContentConfiguration < Spree::Preferences::FileConfiguration
  ...
  has_attached_file :logo, default_url: "/assets/fhc-logo.png"
  has_attached_file :logo_mobile, default_url: "/assets/fhc-logo-mobile.png"
  has_attached_file :logo_mobile_svg, default_url: "/assets/fhc-logo-mobile.png"
# has_attached_file :logo_mobile_svg, default_url: "/assets/ofn-logo-mobile.svg"
  ...
  has_attached_file :home_hero, default_url: "/assets/home/fhc-home.jpg"
  ...
  has_attached_file :footer_logo, default_url: "/assets/fhc-logo-footer.png"
...
#  preference :footer_linkedin_url, :string, default: "http://www.linkedin.com/groups/Open-Food-Foundation-4743336"
  ...
  preference :footer_email, :string, default: "moc.etarctsevrahhserf@olleh"
...
EOS
  ...
  preference :footer_about_url, :string, default: "/sell"
